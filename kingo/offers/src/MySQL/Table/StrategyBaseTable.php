...
CREATE TABLE IF NOT EXISTS {@table} (
  ...
  `start_at` TIMESTAMP DEFAULT NULL COMMENT '起始时间戳，空表示不限制',
  `end_at` TIMESTAMP DEFAULT NULL COMMENT '结束时间戳，空表示不限制',
  `geo2` CHAR(2) DEFAULT NULL COMMENT '国家，空表示全球', 
  `geo3` CHAR(3) DEFAULT NULL COMMENT '国家，空表示全球', 
